...
3. **Work the spec.** TDD, then code. Triple code review on the diff (Gemini + Codex + CodeRabbit, Fable arbitrates). See [how-to-develop.md](how-to-develop.md) and [how-to-review-code.md](how-to-review-code.md).
